...
public class CommonUtils {
	...
	public static synchronized String generateSessionId() {
		return SESSION_ID_PREFIX + String.valueOf(Math.abs(UUID.randomUUID().getLeastSignificantBits())).substring(
				10, 15) + randomAlphaNumericNo(4);
	}
